...
#print(datasets.feature_names) # 컬럼,열의 이름들    <-- x에 대한 정보만 나온당.
#print(datasets.DESCR) # 데이터셋 및 컬럼에 대한 설명 <-- x+ y값에 대한 정보도 여기에 들어있다.     그냥 class0,1,2 columns 이름도 class;;

# 이 데이터는 columns가 13개라서 손을 봐야겠다...이런 귀찮은것...
