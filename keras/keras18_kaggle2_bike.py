...
model.fit(x_train,y_train,epochs=1000000, verbose=1,validation_split=0.2, callbacks=[es]) 
...
# loss값 :  23817.400390625
# R2 :  0.2464691949711344
# RMSE :  154.32886793879092

#y값 log화 시킨후   실질적으로 여기서 나오는  rmse값은 이미 log화 시킨 y값을 또 RMSE함수 들어가서 RMSLE값과 비슷하다.
# loss값 :  1.4510016441345215
# R2 :  0.25952479581392796
# RMSE :  1.2045752284981979    
...
submit_file.to_csv(path + 'firsttest.csv', index=False) # index를 넣지않겠다는 설정    