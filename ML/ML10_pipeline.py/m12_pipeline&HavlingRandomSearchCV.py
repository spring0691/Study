...
classifier_model = HalvingRandomSearchCV(cla_model, parameters, cv=n_splits, n_jobs=-1)      # 분류 classifier
regressor_model = HalvingRandomSearchCV(reg_model, parameters, cv=n_splits, n_jobs=-1)       # 회귀 Regressor
...
최적의 매개변수는요~ :  Pipeline(steps=[('mm', MinMaxScaler()), ('PCA', PCA()),
                ('Rfcl',
                 RandomForestClassifier(max_depth=6, min_samples_leaf=7,       
                                        min_samples_split=5))])
최적의 파라미터는요~ :  {'Rfcl__n_estimators': 100, 'Rfcl__min_samples_split': 5, 'Rfcl__min_samples_leaf': 7, 'Rfcl__max_depth': 6}
model.score로 구한 값은요~ :  1.0
걸린 시간은요~ :  12.577032327651978
acc_score :  1.0
최적 튠 ACC :  1.0
...
최적의 매개변수는요~ :  Pipeline(steps=[('mm', MinMaxScaler()), ('PCA', PCA()),
                ('Rfcl',
                 RandomForestClassifier(max_depth=10, min_samples_leaf=3,      
                                        min_samples_split=5,
                                        n_estimators=200))])
최적의 파라미터는요~ :  {'Rfcl__n_estimators': 200, 'Rfcl__min_samples_split': 5, 'Rfcl__min_samples_leaf': 3, 'Rfcl__max_depth': 10}
model.score로 구한 값은요~ :  0.9298245614035088
걸린 시간은요~ :  13.74044680595398
...
최적의 매개변수는요~ :  Pipeline(steps=[('mm', MinMaxScaler()), ('PCA', PCA()),
                ('Rfcl',
                 RandomForestClassifier(max_depth=10, min_samples_leaf=3,
                                        n_estimators=200))])
최적의 파라미터는요~ :  {'Rfcl__n_estimators': 200, 'Rfcl__min_samples_split': 2, 'Rfcl__min_samples_leaf': 3, 'Rfcl__max_depth': 10}
model.score로 구한 값은요~ :  0.9722222222222222
걸린 시간은요~ :  4.935307264328003
...
최적의 매개변수는요~ :  Pipeline(steps=[('mm', MinMaxScaler()), ('PCA', PCA()),
                ('Rfcl',
                 RandomForestRegressor(max_depth=8, min_samples_leaf=3,
                                       min_samples_split=5))])
최적의 파라미터는요~ :  {'Rfcl__n_estimators': 100, 'Rfcl__min_samples_split': 5, 'Rfcl__min_samples_leaf': 3, 'Rfcl__max_depth': 8}
model.score로 구한 값은요~ :  0.8525947252241711
걸린 시간은요~ :  23.116055488586426
r2_score :  0.8525947252241711
최적 튠 R2 :  0.8525947252241711
...
model.score로 구한 값은요~ :  0.44789810858255985
걸린 시간은요~ :  16.31018376350403
r2_score :  0.44789810858255985
최적 튠 R2 :  0.44789810858255985
...
최적의 파라미터는요~ :  {'Rfcl__n_estimators': 100, 'Rfcl__min_samples_split': 10, 'Rfcl__min_samples_leaf': 10, 'Rfcl__max_depth': 6}
model.score로 구한 값은요~ :  0.32243954666029295
걸린 시간은요~ :  67.74144744873047
r2_score :  0.32243954666029295
최적 튠 R2 :  0.32243954666029295
